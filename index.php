        ...
        <div style="max-width: 28rem; width: 100%">
            ...
            <div class="bg-white shadow rounded p-3 input-group-lg">
                <form action="process-login.php" method="post">
                    <input type="email" class="form-control my-3" placeholder="Email hoặc số điện thoại" name="email" />
                    <input type="password" class="form-control my-3" placeholder="Mật khẩu" name="password" />
                    <button type="submit" class="btn btn-primary w-100 my-3" name="btnlogin">Đăng nhập</button>
                </form>
                                ...
                                <form action="process-register.php" method="post">
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="submit" class="btn btn-success btn-lg" data-bs-dismiss="modal"
                                            name="btnRegister">Đăng ký</button>
                                    </div>
                                </form>
                            </div>
                        </div>
